...
//public Map<EntityPose, EntityDimensions> OBJECT_DUMB_CAST(ImmutableMap<Object, Object> im) { return Map.of(im); }

public abstract class PlayerEntity
extends LivingEntity {
    //public static Map<K,V> OBJECT_DUMB_CAST<K,V>(ImmutableMap<Object, Object> im) { return Map.of((K)(im.keySet().toArray()[0]), (V)(im.values().toArray()[0])); }
    public static Map<EntityPose, EntityDimensions> OBJECT_DUMB_CAST(ImmutableMap<Object, Object> im) { return Map.of((EntityPose)(im.keySet().toArray()[0]), (EntityDimensions)(im.values().toArray()[0])); }
    ...
    private static final Map<EntityPose, EntityDimensions> POSE_DIMENSIONS = OBJECT_DUMB_CAST(ImmutableMap.builder().put(EntityPose.STANDING, STANDING_DIMENSIONS).put(EntityPose.SLEEPING, SLEEPING_DIMENSIONS).put(EntityPose.FALL_FLYING, EntityDimensions.changing(0.6f, 0.6f)).put(EntityPose.SWIMMING, EntityDimensions.changing(0.6f, 0.6f)).put(EntityPose.SPIN_ATTACK, EntityDimensions.changing(0.6f, 0.6f)).put(EntityPose.CROUCHING, EntityDimensions.changing(0.6f, 1.5f)).put(EntityPose.DYING, EntityDimensions.fixed(0.2f, 0.2f)).build());
    ...
    public static enum SleepFailureReason {
        NOT_POSSIBLE_HERE,
        NOT_POSSIBLE_NOW(new TranslatableText("block.minecraft.bed.no_sleep")), //new TranslatableText("block.minecraft.bed.too_far_away")), //TEST: It won't let you sleep.

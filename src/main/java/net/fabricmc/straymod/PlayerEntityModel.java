...
extends BipedEntityModel<T> {
    ...
    public static ModelData getTexturedModelData(Dilation dilation, boolean slim)
    {
        ...
        modelPartData.addChild(EntityModelPartNames.LEFT_ARM, ModelPartBuilder.create().uv(32, 48).cuboid(-5.0f, 18.0f, -1.0f, 1.0f, 3.0f, 1.0f, dilation), ModelTransform.pivot(-5.0f, 18.0f, 0.0f));
        modelPartData.addChild(EntityModelPartNames.RIGHT_ARM, ModelPartBuilder.create().uv(40, 16).cuboid(7.0f, 18.0f, -1.0f, 1.0f, 3.0f, 1.0f, dilation), ModelTransform.pivot(7.0f, 18.0f, 0.0f));
        modelPartData.addChild(EntityModelPartNames.LEFT_LEG, ModelPartBuilder.create().uv(16, 48).cuboid(0.0f, 8.0f, 6.0f, 1.0f, 3.0f, 1.0f, dilation), ModelTransform.pivot(0.0f, 8.0f, 6.0f));
modelPartData.addChild(EntityModelPartNames.RIGHT_LEG, ModelPartBuilder.create().uv(16, 48).cuboid(1.0f, 8.0f, 6.0f, 1.0f, 3.0f, 1.0f, dilation), ModelTransform.pivot(1.0f, 8.0f, 6.0f));
modelPartData.addChild(EntityModelPartNames.HEAD, ModelPartBuilder.create().uv(16, 48).cuboid(0.0f, 16.0f, -2.0f, 3.0f, 3.0f, 3.0f, dilation), ModelTransform.pivot(0.0f, 16.0f, -2.0f));
modelPartData.addChild(EntityModelPartNames.BODY, ModelPartBuilder.create().uv(16, 48).cuboid(0.0f, 18.0f, 0.0f, 3.0f, 3.0f, 6.0f, dilation), ModelTransform.pivot(0.0f, 18.0f, 0.0f));
        ...
        modelPartData.addChild(EntityModelPartNames.JACKET, ModelPartBuilder.create().uv(16, 32).cuboid(-4.0f, -2.0f, -2.0f, 3.0f, 3.0f, 5.0f, dilation.add(0.25f)), ModelTransform.NONE);
        return modelData;
    }
